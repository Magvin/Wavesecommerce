...
import { addWoods, getWoods } from '../../../actions/products_actions';
...
class ManageWoods extends Component {
        ...
        formdata: {
            name: {
                ...
                config: {
                    ...
                    name: 'wood_input',
                    type: 'text',
                    placeholder: 'Enter your name of wood'
                },
                validation: {
                    required: true
                },
    ...
    submitForm = (event) => {
        ...
        if (formIsValid) {
            this.props.dispatch(addWoods(dataToSubmit, existingWoods)).then(response => {
